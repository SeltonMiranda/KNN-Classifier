...
class IDataHandler {
  public:
    ...
    virtual void preProcessImageData(const std::string& folder, const std::unique_ptr<ICrop>& cropper) const = 0;
    ...
    virtual void write_to_csv(const c_knn::FeaturesVec&, std::ofstream& filename, int label) const = 0;  
