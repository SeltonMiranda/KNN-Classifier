...
int main() {
  ...
  std::vector<std::vector<float>> X_test_pucpr, X_test_ufpr04, X_test_ufpr05;
  std::vector<int> y_test_pucpr, y_test_ufpr04, y_test_ufpr05;
  ...
  std::vector<int> predicted_labels{knn->classify(X_test_pucpr)};
  std::vector<std::vector<int>> matrix{knn->confusion_matrix(predicted_labels, y_test_pucpr)};
